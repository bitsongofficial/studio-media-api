...
export default defineNitroPlugin(async (nitroApp) => {
  ...
  const libp2p = await createLibp2p({
    ...
    //       '/ip4/142.132.157.177/tcp/4001/p2p/12D3KooWKDSWRYh52EstzT2ooLBkCAQBbraHLqtPbFX8Qsi13gVN' // bitsong-ipfs-cluster-1
    //     ]
    //   })
    // ],
    services: {
  ...
  await libp2p.dial(multiaddr('/ip4/142.132.157.177/tcp/4001/p2p/12D3KooWKDSWRYh52EstzT2ooLBkCAQBbraHLqtPbFX8Qsi13gVN'))
